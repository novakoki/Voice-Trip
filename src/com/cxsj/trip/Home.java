...
public class Home extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		web.loadUrl("http://blog.shaoziqi.tk/voice-trip/home.php");
		web.addJavascriptInterface(new JavaScriptInterface(), "trip");
		mImageView1.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				web.loadUrl("http://blog.shaoziqi.tk/voice-trip/hot.php");
			}
		});
		...
		mImageView5.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				web.loadUrl("http://blog.shaoziqi.tk/voice-trip/post.html");
			}
		});
